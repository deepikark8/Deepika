...
public static void login() {
	...
	public static void ClickonStuckOpportunitieslink() {
		...
		WebElement elementStuckOpty = driver.findElement(By.xpath("//a[normalize-space()='Stuck Opportunities']"));
